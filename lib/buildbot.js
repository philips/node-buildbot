...
function Buildbot(options) {
  ...
  this._changeHookPath = options['change_hook_path'] || "/change_hook/base";
  this._numBuilds = options['num_builds'] || 10;

  this._builderStatusURL = '/json/builders/%s/builds/';
  this._builderForceURL = '/builders/%s/force';
...
Buildbot.prototype._pollSetup = function() {
